...
\begin{enumerate}
\item How does changing from compact to rich features affect customer assignments, geometric quality and repeatability for K Means and CLASSIX?
\item How does representation affect the CLASSIX construction trace and the accuracy of ExKMC rules at a given rule budget, and do the selected clusters meet the stated operational checks?
\item How sensitive are these findings to feature removal, reduced dimension, small numerical changes and alternative session definitions?
\end{enumerate}
